...
function init()
{
	...
	// esoTalk 1.0.0 beta 3 -> esoTalk 1.0.0 pre 1 (referred to as "beta-1.0")
	if ($versions["eso"] == "1.0.0b3") {
		$versions["eso"] = "beta-1.0";
		writeConfigFile("../config/versions.php", '$versions', $versions);
	}

	// esoTalk 1.0.0 pre 1 -> esoTalk 1.0.0 delta 1
	...
	// esoTalk 1.0.0 delta 1 -> esoTalk 1.0.0 delta 2
	...
	// esoTalk 1.0.0 delta 2 -> esoTalk 1.0.0 delta 3
