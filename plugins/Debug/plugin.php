...
public $name = "Debug";
public $version = "1.0";
public $description = "Shows programming debug information for administrators";
...
public function saveSettings()
{
	...
	writeConfigFile(PATH_CONFIG . "/Debug.php", '$config["Debug"]', $config["Debug"]);
	$this->eso->message("changesSaved");
}

// Add the debug information to the JSON array which is returned from an AJAX request.
public function addInformationToAjaxResult($eso, &$result)
{
	global $config, $language;
...
public function renderDebug($eso)
{
	global $config, $language;
...
public function getHookedFunctions()
{
	$html = "";
