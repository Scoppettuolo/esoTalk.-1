...
public $name = "Captcha";
public $version = "1.0";
public $description = "Provides image verification to prevent bots from joining";
...
public function initCaptchaForm(&$join)
{
	global $language;
...
{
	if (!$input || !hash_equals((string)($_SESSION["captcha"] ?? ""), hash("sha256", $input))) return "captchaError";
}
...
public function saveSettings()
{
	...
	writeConfigFile(PATH_CONFIG . "/Captcha.php", '$config["Captcha"]', $config["Captcha"]);
