...
public $id = "Emoticons";
public $name = "Emoticons";
public $version = "1.1";
public $description = "Converts emoticon text entities into graphic emoticons";
public $author = "Toby Zerner";

public $emoticonDir = "plugins/Emoticons/";
...
public function addEmoticonSettings(&$settings)
{
	global $language;
...
public function emoticon($match, $state)
{
