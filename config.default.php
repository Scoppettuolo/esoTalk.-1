...
define("ESO_VERSION", "1.0.0");

$defaultConfig = array(
// This following block is filled out by the installer in config/config.php.
// New installations use SQLite; legacy MySQL/mysqli keys remain supported.
// Legacy installations without an explicit value continue using mysqli; the installer writes sqlite explicitly.
"databaseDriver" => "mysqli",
"sqlitePath" => "config/esotalk.sqlite",
"mysqlHost" => "127.0.0.1",
"mysqlUser" => "",
"mysqlPass" => "",
"mysqlDB" => "",
...
"gzipOutput" => false, // enable on production if zlib works // Whether or not to compress the page output.  Saves bandwith.
