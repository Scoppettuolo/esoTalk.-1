...
public $view = "settings.view.php";
public $messages = array();
public $emailVerified = 1;
public $languages;
public $form;
...
public function validateAvatarAlignment(&$alignment)
{
...
public function validateFieldAjax($fieldId, $formId, $value, $newPassword = null)
{
	global $config;
