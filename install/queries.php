...
$languageRoot = defined("PATH_ROOT") ? PATH_ROOT . "/languages" : dirname(__DIR__) . "/languages";
if (file_exists($languageRoot . "/{$installLanguage}.php")) {
	include $languageRoot . "/{$installLanguage}.php";
} else {
...
$queries[] = "CREATE TABLE {$config["tablePrefix"]}members (
	...
	emailOnStar tinyint(1) NOT NULL default '1',
		...
		emoticons tinyint(1) NOT NULL default '0',
