<?php
/**
 * esoTalk language pack: Italiano
 */
...
"day ago" => "Ieri",
"days ago" => "%d giorni fa",
"hour ago" => "1 ora fa",
"hours ago" => "%d ore fa",
"minute ago" => "circa un minuto fa",
"minutes ago" => "%d minuti fa",
"month ago" => "1 mese fa",
"months ago" => "%d mesi fa",
"second ago" => "1 secondo fa",
"seconds ago" => "%d secondi fa",
"week ago" => "La settimana scorsa",
"weeks ago" => "%d settimane fa",
"year ago" => "L'anno scorso",
"years ago" => "%d anni fa",
...
"Administrator-plural" => "Amministratori",
"Advanced settings" => "Avanzate",
"Allow registration" => "Consenti registrazione",
...
"Enable" => "Enable",
"Enter a conversation title" => "Inserisci un titolo",
...
"Join this forum" => "Registrati",
"Join us" => "Join us",
"Jump to last" => "Vai all'ultimo",
...
"Mark all conversations as read" => "Segna tutte come lette",
"Member" => "Membro",
"member online" => "membro online",
"Member-plural" => "Membri",
"Members allowed to view this conversation" => "Membri autorizzati",
