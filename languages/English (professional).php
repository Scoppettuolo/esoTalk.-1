...
<li>If you are the forum administrator, <strong>get help on <a href='https://github.com/Scoppettuolo' target='_blank' class='external'>esoTalk support forum</a></strong>.</li>
</ul>",
"First" => "First",
...
"downloadLanguagePacks" => array("class" => "info", "message" => "You can download more language packages from the <a href='https://github.com/Scoppettuolo/languages/' target='_blank' class='external' onclick='return Conversation.externalLink()'>esoTalk website</a>."),
...
"passwordInfo" => array("class" => "info","message" => "Choose a secure password of at least %s characters"),
...
"passwordTooShort" => array("class" => "warning","message" => "Your password must be at least %s characters"),
...
"postTooLong" => array("class" => "warning","message" => "Your post is too long. The maximum number of characters allowed is %s. Please shorten your post and re-submit."),
...
"updatesAvailable" => array("class" => "info","message" => "A new version of the forum (<strong>%s</strong>) is available for download. You have version %s. You may <strong><a href='https://github.com/Scoppettuolo/download'>download it now</a></strong> or <a href='' onclick='Messages.hide();return false'>dismiss this message</a>."),
...
"waitToReply" => array("class" => "warning","message" => "To prevent flooding, you must wait at least %s seconds between starting or replying to conversations."),
