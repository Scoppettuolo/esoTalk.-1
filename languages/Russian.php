...
"dateFormat" => "d.m.Y, H:i T", // see https://php.net/manual/en/function.date.php for details
"day ago" => "Вчера",
"days ago" => "%d дн. назад",
"hour ago" => "1 час назад",
"hours ago" => "%d ч. назад",
"minute ago" => "около минуты назад",
"minutes ago" => "%d мин. назад",
"month ago" => "1 месяц назад",
"months ago" => "%d мес. назад",
"second ago" => "1 сек. назад",
"seconds ago" => "%d сек. назад",
"week ago" => "На прошлой неделе",
"weeks ago" => "%d нед. назад",
"year ago" => "В прошлом году",
"years ago" => "%d г. назад",
...
"Administrator-plural" => "Администраторы",
...
"Enable" => "Enable",
"Enter a conversation title" => "Введите заголовок",
...
"Join this forum" => "Регистрация",
"Join us" => "Join us",
"Jump to last" => "К последнему",
...
"Mark all conversations as read" => "Отметить всё прочитанным",
"Member" => "Участник",
"member online" => "участник онлайн",
"Member-plural" => "Участники",
"Members allowed to view this conversation" => "Кто может видеть эту беседу",
...
"Skins" => "Темы",
"Starred" => "Избранное",
"Start a conversation" => "Начать беседу",
