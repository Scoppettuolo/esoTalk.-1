...
"dateFormat" => "j F Y, H:i T", // see https://php.net/manual/en/function.date.php for details
"day ago" => "เมื่อวาน",
"days ago" => "%d วันที่แล้ว",
"hour ago" => "1 ชั่วโมงที่แล้ว",
"hours ago" => "%d ชั่วโมงที่แล้ว",
"minute ago" => "ประมาณ 1 นาทีที่แล้ว",
"minutes ago" => "%d นาทีที่แล้ว",
"month ago" => "1 เดือนที่แล้ว",
"months ago" => "%d เดือนที่แล้ว",
"second ago" => "1 วินาทีที่แล้ว",
"seconds ago" => "%d วินาทีที่แล้ว",
"week ago" => "สัปดาห์ที่แล้ว",
"weeks ago" => "%d สัปดาห์ที่แล้ว",
"year ago" => "ปีที่แล้ว",
"years ago" => "%d ปีที่แล้ว",
...
"Administrator-plural" => "ผู้ดูแลระบบ",
"Advanced settings" => "การตั้งค่าขั้นสูง",
"Allow registration" => "อนุญาตการลงทะเบียน",
"Appearance settings" => "การตั้งค่าลักษณะ",
"Are you human" => "คุณเป็นมนุษย์หรือไม่",
"author" => "by %s",
...
"Enable" => "Enable",
"Enter a conversation title" => "ใส่ชื่อการสนทนา",
...
<li>If you are the forum administrator, then you can <strong>get help on the <a href='https://github.com/Scoppettuolo' target='_blank' class='external'>esoTalk support forum</a></strong>.</li>
<li>Try hitting the computer - that sometimes works for me.</li>
</ul>",
"First" => "แรก",
"First posted" => "First posted",
"Fixed" => "ความกว้างคงที่",
...
"Join this forum" => "เข้าร่วมฟอรัม",
"Join us" => "Join us",
"Jump to last" => "ไปยังล่าสุด",
...
"Mark all conversations as read" => "ทำเครื่องหมายว่าอ่านแล้วทั้งหมด",
"Member" => "สมาชิก",
"member online" => "สมาชิกออนไลน์",
"Member-plural" => "สมาชิก",
"Members allowed to view this conversation" => "สมาชิกที่ดูการสนทนานี้ได้",
"members online" => "สมาชิกออนไลน์",
...
"accountValidated" => array("class" => "success", "message" => "Cool! Your account has been validated and you can now start participating in conversations. Why not <a href='%s'>start one</a> yourself?"),
...
"downloadLanguagePacks" => array("class" => "info", "message" => "You can download more language packs from the <a href='https://github.com/Scoppettuolo/languages/' target='_blank' class='external' onclick='return Conversation.externalLink()'>esoTalk website</a>."),
"downloadPlugins" => array("class" => "info", "message" => "You can download more plugins from the <a href='https://github.com/Scoppettuolo/plugins/' target='_blank' class='external' onclick='return Conversation.externalLink()'>esoTalk website</a>."),
"downloadSkins" => array("class" => "info", "message" => "You can download more skins from the <a href='https://github.com/Scoppettuolo/skins/' target='_blank' class='external' onclick='return Conversation.externalLink()'>esoTalk website</a>."),
...
"incorrectLogin" => array("class" => "warning", "message" => "Your login details were incorrect. <a href='%s'>Have you forgotten your password?</a>"),
...
"loginRequired" => array("class" => "warning", "message" => "You need to <a href='#' onclick='showLogin();return false'>log in</a> or <a href='?p=join'>create an account</a> to do anything on this forum."),
...
"passwordInfo" => array("class" => "info", "message" => "Choose a secure password of at least 8 characters."),
...
"passwordTooShort" => array("class" => "warning", "message" => "Your password must be at least 8 characters."),
...
"postTooLong" => array("class" => "warning", "message" => "Your post is really, really long! Too long! The maximum number of characters allowed is %s. That's really long!"),
...
"unvalidated" => array("class" => "warning", "message" => "Your account still needs to be validated before you can do anything on this forum. Go check out your <a href='%s'>settings</a> for instructions on how to validate your account."),
"updatesAvailable" => array("class" => "info", "message" => "A new version of esoTalk (<strong>%s</strong>) is available for download. You have version %s. <strong><a href='https://github.com/Scoppettuolo/download'>Get it now</a></strong>!"),
...
"viewMore" => array("class" => "info", "message" => "Your search found more than %s conversations. <a href='%s' onclick='Search.viewMore();return false'>View more</a>"),
...
"waitToReply" => array("class" => "warning", "message" => "You must wait at least %s seconds between starting or replying to conversations. Take a deep breath and try again."),
...
// User interface
"welcomeTitle" => "Welcome to the esoTalk installer",
"welcomeDescription" => "Thank you for choosing the esoTalk forum software. Using the installer, you can have your forum ready to go in three easy steps. For more information, you may consult the <a href='https://github.com/Scoppettuolo/docs/setup' class='external' target='_blank'>setup guide</a> or get help on the <a href='https://github.com/Scoppettuolo' class='external' target='_blank'>esoTalk support forum</a>.",
...
"setupInfoDescription" => "We need a few details from you so we can get your forum ready to go. If you have any trouble, read the <a href='https://github.com/Scoppettuolo/docs/setup' class='external' target='_blank'>setup guide</a> or get help on the <a href='https://github.com/Scoppettuolo' class='external' target='_blank'>esoTalk support forum</a>.",
"specifyBasicDetails" => "Specify basic details",
"forumTitle" => "Forum title",
"forumDescription" => "Forum description",
"defaultLanguage" => "Default language",
"moreLanguagePacks" => "More language packs are <a href='https://github.com/Scoppettuolo/languages' class='external' target='_blank'>available for download</a>.",
"configureDatabase" => "Configure the database",
"databaseDescription" => "esoTalk needs a database to store all your forum's data in, such as conversations and posts. If you're unsure of any of these details, you may need to ask your hosting provider.",
"mysqlHostAddress" => "MySQL host address",
"mysqlUsername" => "MySQL username",
"mysqlPassword" => "MySQL password",
"mysqlDatabase" => "MySQL database",
"outgoingMailServer" => "Configure the mail server",
"mailServerDescription" => "esoTalk needs a mail server to send emails to members, but your forum will work with email sending disabled. If you haven't configured server-side email sending or are unsure of whether you can send emails, leave this disabled and change it later.",
...
"administratorDescription" => "esoTalk will use the following information to set up your administrator account on your forum.",
...
"getHelp" => "If you run into any other problems or just want some help with the installation, feel free to join the <a href='https://github.com/Scoppettuolo' class='external' target='_blank'>esoTalk support forum</a> where a bunch of friendly people will be happy to help you out.",
"fatalErrorTitle" => "Uh oh! It's a fatal error...",
"installerEncounteredError" => "The forum installer encountered an error.",
"fatalErrorDescription" => "The esoTalk installer has encountered a nasty error which is making it impossible to install a forum on your server. But don't feel down, <strong>here are a few things you can try</strong>:",
...
"getHelpTip" => "<li><strong>Get help.</strong> Go on the <a href='https://github.com/Scoppettuolo' class='external' target='_blank'>esoTalk support forum</a> to see if anyone else is having the same problem as you are. If not, open a new issue, including the error details below.</li>",
...
"filePermissionsError" => "The following files/folders are not writeable: <strong>%s</strong>.<br/><small>
<strong>Linux / macOS:</strong> chmod them to 755 or 777.<br/>
<strong>XAMPP / Windows:</strong> Right-click the folders → Properties → Security → give the user that runs Apache (usually the current Windows user or SYSTEM) Full Control / Modify permissions. Make sure the folders exist.
</small>",
...
"mbstringWarning" => "The <strong>mbstring</strong> extension is not enabled.<br/><small>UTF-8 handling may be incomplete. Enable <code>extension=mbstring</code> in php.ini and restart Apache.</small>",
"gdExtensionError" => "The <strong>GD extension</strong> is not enabled.<br/><small>
This is recommended to save avatars and generate captcha images. The forum can still be installed and used without it (avatars and Captcha will simply be unavailable until you enable GD).<br/><br/>
<strong>XAMPP / Windows users:</strong><br/>
1. Open the file <code>php.ini</code> (in XAMPP Control Panel click the Config button next to Apache → PHP (php.ini)).<br/>
2. Find the line <code>;extension=gd</code> and remove the semicolon so it becomes <code>extension=gd</code>.<br/>
3. Save the file and <strong>restart Apache</strong> from the XAMPP Control Panel.<br/>
4. Refresh this page.
</small>",
