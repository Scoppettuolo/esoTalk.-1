...
"dateFormat" => "Y年n月j日 H:i T", // see https://php.net/manual/en/function.date.php for details
"day ago" => "昨日",
"days ago" => "%d日前",
"hour ago" => "1時間前",
"hours ago" => "%d時間前",
...
"Enable" => "Enable",
"Enter a conversation title" => "タイトルを入力",
...
"Mark all conversations as read" => "すべて既読にする",
"Member" => "メンバー",
"member online" => "オンラインのメンバー",
"Member-plural" => "メンバー",
"Members allowed to view this conversation" => "この会話を閲覧できるメンバー",
"members online" => "オンラインのメンバー",
